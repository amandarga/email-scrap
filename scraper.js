...
async function scrapePENews() {
  const url = "https://g1.globo.com/pe/pernambuco/";
...
async function sendEmail(news) {
  ...
  const mailOptions = {
    ...
    to: "amandargarruda@gmail.com",
    subject: "PE Noticias",
    text: `Aqui estão as últimas notícias sobre Recife e regioes ! :\n\n${emailContent}`,
  };
